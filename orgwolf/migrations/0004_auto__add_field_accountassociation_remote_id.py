...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountAssociation.remote_id'
        db.add_column(u'orgwolf_accountassociation', 'remote_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountAssociation.remote_id'
        db.delete_column(u'orgwolf_accountassociation', 'remote_id')
