...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccountAssociation'
        db.create_table(u'orgwolf_accountassociation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ow_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orgwolf.OrgWolfUser'])),
        ...
        db.send_create_signal(u'orgwolf', ['AccountAssociation'])


    def backwards(self, orm):
        # Deleting model 'AccountAssociation'
        db.delete_table(u'orgwolf_accountassociation')
    ...
    models = {
        ...
        u'orgwolf.accountassociation': {
            'Meta': {'object_name': 'AccountAssociation'},
