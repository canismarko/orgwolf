...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.source_node'
        db.add_column(u'wolfmail_message', 'source_node',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='deferred_message', unique=True, null=True, to=orm['gtd.Node']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.source_node'
        db.delete_column(u'wolfmail_message', 'source_node_id')
    ...
    models = {
        ...
        u'wolfmail.message': {
            ...
            'source_node': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'deferred_message'", 'unique': 'True', 'null': 'True', 'to': u"orm['gtd.Node']"}),
