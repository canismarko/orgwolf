...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Node.scheduled'
        db.delete_column(u'gtd_node', 'scheduled')

        # Deleting field 'Node.scheduled_time_specific'
        db.delete_column(u'gtd_node', 'scheduled_time_specific')

        # Deleting field 'Node.deadline'
        db.delete_column(u'gtd_node', 'deadline')

        # Deleting field 'Node.deadline_time_specific'
        db.delete_column(u'gtd_node', 'deadline_time_specific')


    def backwards(self, orm):
        # Adding field 'Node.scheduled'
        db.add_column(u'gtd_node', 'scheduled',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.scheduled_time_specific'
        db.add_column(u'gtd_node', 'scheduled_time_specific',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Node.deadline'
        db.add_column(u'gtd_node', 'deadline',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.deadline_time_specific'
        db.add_column(u'gtd_node', 'deadline_time_specific',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
