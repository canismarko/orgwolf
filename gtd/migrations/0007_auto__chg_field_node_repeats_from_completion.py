...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Node.repeats_from_completion'
        db.alter_column(u'gtd_node', 'repeats_from_completion', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Node.repeats_from_completion'
        db.alter_column(u'gtd_node', 'repeats_from_completion', self.gf('django.db.models.fields.NullBooleanField')(null=True))
