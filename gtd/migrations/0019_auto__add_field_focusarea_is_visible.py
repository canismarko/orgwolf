...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FocusArea.is_visible'
        db.add_column(u'gtd_focusarea', 'is_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FocusArea.is_visible'
        db.delete_column(u'gtd_focusarea', 'is_visible')
