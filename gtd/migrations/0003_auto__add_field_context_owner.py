...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'gtd_context', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orgwolf.OrgWolfUser'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context.owner'
        db.delete_column(u'gtd_context', 'owner_id')
