...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'gtd_node', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['orgwolf.OrgWolfUser']))

    def backwards(self, orm):

        # Changing field 'Node.owner'
        db.alter_column(u'gtd_node', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['orgwolf.OrgWolfUser']))
