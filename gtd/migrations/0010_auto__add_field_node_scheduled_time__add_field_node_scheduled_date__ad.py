...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.scheduled_time'
        db.add_column(u'gtd_node', 'scheduled_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.scheduled_date'
        db.add_column(u'gtd_node', 'scheduled_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.deadline_time'
        db.add_column(u'gtd_node', 'deadline_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.deadline_date'
        db.add_column(u'gtd_node', 'deadline_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.scheduled_time'
        db.delete_column(u'gtd_node', 'scheduled_time')

        # Deleting field 'Node.scheduled_date'
        db.delete_column(u'gtd_node', 'scheduled_date')

        # Deleting field 'Node.deadline_time'
        db.delete_column(u'gtd_node', 'deadline_time')

        # Deleting field 'Node.deadline_date'
        db.delete_column(u'gtd_node', 'deadline_date')
