...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tag.tag_string'
        db.alter_column(u'gtd_tag', 'tag_string', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True, null=True))
        # Adding unique constraint on 'Tag', fields ['tag_string']
        db.create_unique(u'gtd_tag', ['tag_string'])

        # Adding field 'Node.slug'
        db.add_column(u'gtd_node', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='system-title', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Tag', fields ['tag_string']
        db.delete_unique(u'gtd_tag', ['tag_string'])


        # Changing field 'Tag.tag_string'
        db.alter_column(u'gtd_tag', 'tag_string', self.gf('django.db.models.fields.CharField')(default=':none:', max_length=10))
        # Deleting field 'Node.slug'
        db.delete_column(u'gtd_node', 'slug')
    ...
    models = {
        ...
        u'gtd.tag': {
            ...
            'tag_string': ('django.db.models.fields.CharField', [], {'max_length': '10', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'gtd.todostate': {
