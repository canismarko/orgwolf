...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.assigned'
        db.add_column(u'gtd_node', 'assigned',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'assigned_node_set', null=True, to=orm['gtd.Contact']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Node.assigned'
        db.delete_column(u'gtd_node', 'assigned_id')
