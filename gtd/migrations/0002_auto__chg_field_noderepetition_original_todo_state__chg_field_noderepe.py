...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NodeRepetition.original_todo_state'
        db.alter_column(u'gtd_noderepetition', 'original_todo_state_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['gtd.TodoState']))

        # Changing field 'NodeRepetition.new_todo_state'
        db.alter_column(u'gtd_noderepetition', 'new_todo_state_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['gtd.TodoState']))
        # Adding field 'TodoState.class_size'
        db.add_column(u'gtd_todostate', 'class_size',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'NodeRepetition.original_todo_state'
        db.alter_column(u'gtd_noderepetition', 'original_todo_state_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gtd.TodoState']))

        # Changing field 'NodeRepetition.new_todo_state'
        db.alter_column(u'gtd_noderepetition', 'new_todo_state_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gtd.TodoState']))
        # Deleting field 'TodoState.class_size'
        db.delete_column(u'gtd_todostate', 'class_size')
