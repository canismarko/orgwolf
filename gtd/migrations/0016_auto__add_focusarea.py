...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gtd_focusarea', (
        ...
        db.send_create_signal(u'gtd', ['FocusArea'])

        # Adding M2M table for field focus_areas on 'Node'
        m2m_table_name = db.shorten_name(u'gtd_node_focus_areas')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('node', models.ForeignKey(orm[u'gtd.node'], null=False)),
            ('focusarea', models.ForeignKey(orm[u'gtd.focusarea'], null=False))
        ))
        db.create_unique(m2m_table_name, ['node_id', 'focusarea_id'])


    def backwards(self, orm):
        # Deleting model 'FocusArea'
        db.delete_table(u'gtd_focusarea')

        # Removing M2M table for field focus_areas on 'Node'
        db.delete_table(db.shorten_name(u'gtd_node_focus_areas'))
