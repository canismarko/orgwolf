...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'gtd_tag', 'tag_string', self.gf('django.db.models.fields.CharField')(default=':system:', unique=True, max_length=10))

    def backwards(self, orm):

        # Changing field 'Tag.tag_string'
        db.alter_column(u'gtd_tag', 'tag_string', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10, null=True))
