...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.end_time'
        db.add_column(u'gtd_node', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.end_date'
        db.add_column(u'gtd_node', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.end_time'
        db.delete_column(u'gtd_node', 'end_time')

        # Deleting field 'Node.end_date'
        db.delete_column(u'gtd_node', 'end_date')
